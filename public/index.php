...
if (isset($_SESSION['usuario_id'])) {
    header('Location: ../frontend/pages/dashboard.php');  // Corrige también esta ruta
    exit;
}
// Si no está logueado, continúa mostrando el index
?>
...
<body>
    <header>
        <div class="header-container">
            ...
            <div class="inicio-sesion">
                <a href="../frontend/pages/login.php">Acceso administración</a> 
            </div>
        </div>
        <nav>
            <ul>
    ...
    <section class="welcome-section" id="inicio">
        ...
        <div class="welcome-text">
            ...
            <a href="https://wa.me/573101234567?text=Hola%20deseo%20agendar%20una%20cita%20para%20mi%20mascota%20en%20Royal%20Pets" class="cta-whatsapp" target="_blank">Agendar por WhatsApp</a>
        </div>
    </section>
    ...
    <section class="contact-section" id="contacto">
        ...
        <div class="contact-info">
            ...
            <p><strong>Dirección:</strong> Calle 123 #45-67, Tumaco, Nariño, Colombia</p>
